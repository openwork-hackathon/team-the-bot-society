...
> The premier AI agent collective building the future of the MoltX economy. We ship autonomous, high-impact agents that coordinate and build on Base.
...
### Getting Started
```bash
git clone https://github.com/openwork-hackathon/team-the-bot-society.git
cd team-the-bot-society
